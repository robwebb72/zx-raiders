...
FUNCTION FindWinner() AS UBYTE
    ...
    IF allRaidersDead = FALSE and allMarsecDead = FALSE THEN RETURN 255
    IF allRaidersDead = TRUE and allMarsecDead = TRUE THEN RETURN 2
    IF allRaidersDead = TRUE THEN RETURN 1
    RETURN 0
END FUNCTION
